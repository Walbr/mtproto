function getrequest(tl_constructor,_flags,vector_type){
	...
	case 0xedf17c12: {// userFull
		...
		if(_flags & (1 << 13)) request[i++]=Object.fromEntries([["video_calls_available","true"]])
		request[i++]=Object.fromEntries([["user","User"]])
	...
	case 0x5b38c6c1: {// inputMediaUploadedDocument
		...
		if(_flags & (1 << 4)) request[i++]=Object.fromEntries([["force_file","true"]])
		request[i++]=Object.fromEntries([["file","InputFile"]])
	...
	case 0x938458c1: {// user
		...
		if(_flags & (1 << 25)) request[i++]=Object.fromEntries([["apply_min_photo","true"]])
		request[i++]=Object.fromEntries([["id","int"]])
	...
	case 0xf0e6672a: {// channelFull
		...
		if(_flags & (1 << 20)) request[i++]=Object.fromEntries([["can_view_stats","true"]])
		if(_flags & (1 << 22)) request[i++]=Object.fromEntries([["blocked","true"]])
		request[i++]=Object.fromEntries([["id","int"]])
		request[i++]=Object.fromEntries([["about","string"]])
		...
		if(_flags & (1 << 12)) request[i++]=Object.fromEntries([["stats_dc","int"]])
		request[i++]=Object.fromEntries([["pts","int"]])
		break
	}
	...
	case 0x353a686b: {// messageFwdHeader
		request = {}
		request[i++]=Object.fromEntries([["flags","#"]])
		...
		if(_flags & (1 << 6)) request[i++]=Object.fromEntries([["psa_type","string"]])
		break
	}
	...
	case 0xc6dc0c66: {// messages.featuredStickersNotModified
		request = {[i++]:{count:"int"}}
		break
	}
	case 0xb6abc341: {// messages.featuredStickers
		request = {[i++]:{hash:"int"},[i++]:{count:"int"},[i++]:{sets:"Vector<StickerSetCovered>"},[i++]:{unread:"Vector<long>"}}
		break
	}
	...
	case 0x7311ca11: {// webPageNotModified
		request = {}
		request[i++]=Object.fromEntries([["flags","#"]])
		if(_flags & (1 << 0)) request[i++]=Object.fromEntries([["cached_page_views","int"]])
		break
	}
	...
	case 0x1b8f4ad1: {// phoneCallWaiting
		request = {}
		request[i++]=Object.fromEntries([["flags","#"]])
		if(_flags & (1 << 6)) request[i++]=Object.fromEntries([["video","true"]])
		request[i++]=Object.fromEntries([["id","long"]])
		request[i++]=Object.fromEntries([["access_hash","long"]])
		request[i++]=Object.fromEntries([["date","int"]])
	...
	case 0xfc878fc8: {// phoneCallProtocol
		request = {}
		request[i++]=Object.fromEntries([["flags","#"]])
		...
		request[i++]=Object.fromEntries([["library_versions","Vector<string>"]])
		break
	}
	...
	case 0x98657f0d: {// page
		...
		if(_flags & (1 << 3)) request[i++]=Object.fromEntries([["views","int"]])
		break
	}
	...
	case 0x86e18161: {// poll
		request = {[i++]:{id:"long"},[i++]:{flags:"#"},[i++]:{closed:"flags.0?true"},[i++]:{public_voters:"flags.1?true"},[i++]:{multiple_choice:"flags.2?true"},[i++]:{quiz:"flags.3?true"},[i++]:{question:"string"},[i++]:{answers:"Vector<PollAnswer>"},[i++]:{close_period:"flags.4?int"},[i++]:{close_date:"flags.5?int"}}
		break
	}
	...
	case 0xbadcc1a3: {// pollResults
		...
		if(_flags & (1 << 3)) request[i++]=Object.fromEntries([["recent_voters","Vector<int>"]])
		if(_flags & (1 << 4)) request[i++]=Object.fromEntries([["solution","string"]])
		if(_flags & (1 << 4)) request[i++]=Object.fromEntries([["solution_entities","Vector<MessageEntity>"]])
		break
	}
	case 0xf94e5f1: {// inputMediaPoll
		request = {}
		request[i++]=Object.fromEntries([["flags","#"]])
		request[i++]=Object.fromEntries([["poll","Poll"]])
		if(_flags & (1 << 0)) request[i++]=Object.fromEntries([["correct_answers","Vector<bytes>"]])
		if(_flags & (1 << 1)) request[i++]=Object.fromEntries([["solution","string"]])
		if(_flags & (1 << 1)) request[i++]=Object.fromEntries([["solution_entities","Vector<MessageEntity>"]])
		break
	}
	...
	case 0x5fb224d5: {// chatAdminRights
		...
		if(_flags & (1 << 10)) request[i++]=Object.fromEntries([["anonymous","true"]])
		break
	}
	...
	case 0x42f88f2c: {// updateMessagePollVote
		request = {[i++]:{poll_id:"long"},[i++]:{user_id:"int"},[i++]:{options:"Vector<bytes>"}}
		break
	}
	case 0xa28e5559: {// messageUserVote
		request = {[i++]:{user_id:"int"},[i++]:{option:"bytes"},[i++]:{date:"int"}}
		break
	}
	case 0x36377430: {// messageUserVoteInputOption
		request = {[i++]:{user_id:"int"},[i++]:{date:"int"}}
		break
	}
	case 0xe8fe0de: {// messageUserVoteMultiple
		request = {[i++]:{user_id:"int"},[i++]:{options:"Vector<bytes>"},[i++]:{date:"int"}}
		break
	}
	case 0x823f649: {// messages.votesList
		request = {}
		request[i++]=Object.fromEntries([["flags","#"]])
		request[i++]=Object.fromEntries([["count","int"]])
		request[i++]=Object.fromEntries([["votes","Vector<MessageUserVote>"]])
		request[i++]=Object.fromEntries([["users","Vector<User>"]])
		if(_flags & (1 << 0)) request[i++]=Object.fromEntries([["next_offset","string"]])
		break
	}
	case 0xbbc7515d: {// keyboardButtonRequestPoll
		request = {}
		request[i++]=Object.fromEntries([["flags","#"]])
		if(_flags & (1 << 0)) request[i++]=Object.fromEntries([["quiz","Bool"]])
		request[i++]=Object.fromEntries([["text","string"]])
		break
	}
	...
	case 0xf568028a: {// bankCardOpenUrl
		request = {[i++]:{url:"string"},[i++]:{name:"string"}}
		break
	}
	case 0x3e24e573: {// payments.bankCardData
		request = {[i++]:{title:"string"},[i++]:{open_urls:"Vector<BankCardOpenUrl>"}}
		break
	}
	case 0xf8ec284b: {// peerSelfLocated
		request = {[i++]:{expires:"int"}}
		break
	}
	case 0x7438f7e8: {// dialogFilter
		request = {}
		request[i++]=Object.fromEntries([["flags","#"]])
		if(_flags & (1 << 0)) request[i++]=Object.fromEntries([["contacts","true"]])
		if(_flags & (1 << 1)) request[i++]=Object.fromEntries([["non_contacts","true"]])
		if(_flags & (1 << 2)) request[i++]=Object.fromEntries([["groups","true"]])
		if(_flags & (1 << 3)) request[i++]=Object.fromEntries([["broadcasts","true"]])
		if(_flags & (1 << 4)) request[i++]=Object.fromEntries([["bots","true"]])
		if(_flags & (1 << 11)) request[i++]=Object.fromEntries([["exclude_muted","true"]])
		if(_flags & (1 << 12)) request[i++]=Object.fromEntries([["exclude_read","true"]])
		if(_flags & (1 << 13)) request[i++]=Object.fromEntries([["exclude_archived","true"]])
		request[i++]=Object.fromEntries([["id","int"]])
		request[i++]=Object.fromEntries([["title","string"]])
		if(_flags & (1 << 25)) request[i++]=Object.fromEntries([["emoticon","string"]])
		request[i++]=Object.fromEntries([["pinned_peers","Vector<InputPeer>"]])
		request[i++]=Object.fromEntries([["include_peers","Vector<InputPeer>"]])
		request[i++]=Object.fromEntries([["exclude_peers","Vector<InputPeer>"]])
		break
	}
	case 0x77744d4a: {// dialogFilterSuggested
		request = {[i++]:{filter:"DialogFilter"},[i++]:{description:"string"}}
		break
	}
	case 0x26ffde7d: {// updateDialogFilter
		...
		request[i++]=Object.fromEntries([["flags","#"]])
		request[i++]=Object.fromEntries([["id","int"]])
		if(_flags & (1 << 0)) request[i++]=Object.fromEntries([["filter","DialogFilter"]])
		break
	}
	case 0xa5d72105: {// updateDialogFilterOrder
		request = {[i++]:{order:"Vector<int>"}}
		break
	}
	case 0x3504914f: {// updateDialogFilters
		request = {}
		break
	}
	case 0xb637edaf: {// statsDateRangeDays
		request = {[i++]:{min_date:"int"},[i++]:{max_date:"int"}}
		break
	}
	case 0xcb43acde: {// statsAbsValueAndPrev
		request = {[i++]:{current:"double"},[i++]:{previous:"double"}}
		break
	}
	case 0xcbce2fe0: {// statsPercentValue
		request = {[i++]:{part:"double"},[i++]:{total:"double"}}
		break
	}
	case 0x4a27eb2d: {// statsGraphAsync
		request = {[i++]:{token:"string"}}
		break
	}
	case 0xbedc9822: {// statsGraphError
		request = {[i++]:{error:"string"}}
		break
	}
	case 0x8ea464b6: {// statsGraph
		request = {}
		request[i++]=Object.fromEntries([["flags","#"]])
		request[i++]=Object.fromEntries([["json","DataJSON"]])
		if(_flags & (1 << 0)) request[i++]=Object.fromEntries([["zoom_token","string"]])
		break
	}
	case 0xad4fc9bd: {// messageInteractionCounters
		request = {[i++]:{msg_id:"int"},[i++]:{views:"int"},[i++]:{forwards:"int"}}
		break
	}
	case 0xbdf78394: {// stats.broadcastStats
		request = {[i++]:{period:"StatsDateRangeDays"},[i++]:{followers:"StatsAbsValueAndPrev"},[i++]:{views_per_post:"StatsAbsValueAndPrev"},[i++]:{shares_per_post:"StatsAbsValueAndPrev"},[i++]:{enabled_notifications:"StatsPercentValue"},[i++]:{growth_graph:"StatsGraph"},[i++]:{followers_graph:"StatsGraph"},[i++]:{mute_graph:"StatsGraph"},[i++]:{top_hours_graph:"StatsGraph"},[i++]:{interactions_graph:"StatsGraph"},[i++]:{iv_interactions_graph:"StatsGraph"},[i++]:{views_by_source_graph:"StatsGraph"},[i++]:{new_followers_by_source_graph:"StatsGraph"},[i++]:{languages_graph:"StatsGraph"},[i++]:{recent_message_interactions:"Vector<MessageInteractionCounters>"}}
		break
	}
	case 0xe66fbf7b: {// inputMediaDice
		request = {[i++]:{emoticon:"string"}}
		break
	}
	case 0x3f7ee58b: {// messageMediaDice
		request = {[i++]:{value:"int"},[i++]:{emoticon:"string"}}
		break
	}
	case 0xe67f520e: {// inputStickerSetDice
		request = {[i++]:{emoticon:"string"}}
		break
	}
	case 0x98f6ac75: {// help.promoDataEmpty
		request = {[i++]:{expires:"int"}}
		break
	}
	case 0x8c39793f: {// help.promoData
		request = {}
		request[i++]=Object.fromEntries([["flags","#"]])
		if(_flags & (1 << 0)) request[i++]=Object.fromEntries([["proxy","true"]])
		request[i++]=Object.fromEntries([["expires","int"]])
		request[i++]=Object.fromEntries([["peer","Peer"]])
		request[i++]=Object.fromEntries([["chats","Vector<Chat>"]])
		request[i++]=Object.fromEntries([["users","Vector<User>"]])
		if(_flags & (1 << 1)) request[i++]=Object.fromEntries([["psa_type","string"]])
		if(_flags & (1 << 2)) request[i++]=Object.fromEntries([["psa_message","string"]])
		break
	}
...
//	manual added constructors
	...
	case 0xf35c6d01:{//rpc_result#f35c6d01 req_msg_id:long result:Object = RpcResult;
		request = {}
		request[i++]=Object.fromEntries([["req_msg_id","long"]])
		break
	}
